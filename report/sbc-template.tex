...
a quantidade de nós abertos e o custo do caminho em cada execução.
...
\begin{table}[h]
    ...
    \begin{tabular}{lSSSSSS}
        ...
        Aprofundamente Iterativo    & 3843.34 & 5011.21 & 98.50  & 58.78  \\
...
do custo dos caminhos e os nós abertos.

// Falar do máximo do astar peso 1 no meio do fogo

\begin{figure}[h]
    \centering
    \includegraphics[width=.85\textwidth]{figuras/plot2}
    \caption{Gráficos dos Testes}
    \label{fig:plot2}
\end{figure}
